...
<section class="aboutus_part">
        ...
        <div class="container">
          ...
          <div class="aboutus_partner_items_container">
            <div class="items">
              <div class="item">
                <img
                  src="{{ asset('frontend') }}/assets/images/about_page_image/partner_images/partner (6).png"
                  alt=""
                />
              </div>
              <div class="item">
                <img
                  src="{{ asset('frontend') }}/assets/images/about_page_image/partner_images/partner (5).png"
                  alt=""
                />
              </div>
              <div class="item">
                <img
                  src="{{ asset('frontend') }}/assets/images/about_page_image/partner_images/partner (4).png"
                  alt=""
                />
              </div>
              <div class="item">
                <img
                  src="{{ asset('frontend') }}/assets/images/about_page_image/partner_images/partner (3).png"
                  alt=""
                />
              </div>
              <div class="item">
                <img
                  src="{{ asset('frontend') }}/assets/images/about_page_image/partner_images/partner (2).png"
                  alt=""
                />
              </div>
              <div class="item">
                <img
                  src="{{ asset('frontend') }}/assets/images/about_page_image/partner_images/partner (1).png"
                  alt=""
                />
              </div>
            </div>
  ...
  <!-- /motivation -->
  <!-- mission -->
  <section class="mission_part">
    <div class="container">
      <div class="mission_part_details">
        <div class="mission_part_image">
          <img src="{{ asset('frontend') }}/assets//images/about_page_image/mission.png" alt="" />
        </div>
    ...
    <div class="container">
      <div class="vision_part_details">
        ...
        <div class="vision_part_image">
          <img src="{{ asset('frontend') }}/assets//images/about_page_image/vision.png" alt="" />
        </div>
      </div>
    </div>
  </section>
      ...
      <div class="container">
          <div class="team_area_details">
              <div class="team_area_title">
                ...
                <p>
                  আমরা এখানে আমাদের সহকর্মী হিসেবে এমন মানুষদেরকে পেয়েছি, যারা প্রতিষ্ঠানের মূল লক্ষ্যকে মনে প্রাণে নিজেদের জন্যও ধারণ করেন এবং সে লক্ষ্যকে বাস্তবায়নের জন্য সর্বাত্মক প্রচেষ্টা চালিয়ে যাচ্ছেন। আর যোগ্যতার প্রশ্নে টেক পার্ক আইটি প্রথম থেকেই আপোসহীন থেকে নিয়োগ কার্যক্রম সম্পাদন করে যাচ্ছে। ফলে একদল আগ্রহী ও যোগ্যতাসম্পন্ন তরুণ কর্মীর সমাহার ঘটেছে এ প্রতিষ্ঠানে।
                </p>
              </div>
              <div class="team_area_carousel">
                  <div class="carousel_image">
                      <img src="{{ asset('frontend') }}/assets/images/about_page_image/team_images/team (3).png" alt="">
                  </div>
                  <div class="carousel_images">
                      <div class="single_image">
                          <img src="{{ asset('frontend') }}/assets/images/about_page_image/team_images/team (1).png" alt="">
                      </div>
                      <div class="single_image">
                          <img src="{{ asset('frontend') }}/assets/images/about_page_image/team_images/team (2).png" alt="">
                      </div>
                      <div class="single_image">
                          <img src="{{ asset('frontend') }}/assets/images/about_page_image/team_images/team (1).png" alt="">
                      </div>
              ...
              <div class="trainers_details">
                  <div class="trainer_details">
                      <div class="trainer_images">
                          <div class="image">
                              <img src="{{ asset('frontend') }}/assets/images/about_page_image/trainers_images/trainer.png" alt="">
                          </div>
                      ...
                      <div class="trainer_descrip">
                          <p>
                              ৩ বছরেরও বেশি সময় ধরে ওয়েব ডিজাইন ও ডেভোলাপম্যান্ট ট্রেইনার হিসেবে কর্মরত আছেন। এছাড়াও তিনি গত ৫ বছর ধরে Fiverr, Upwork ও Freelancer.com এ সফলতার সাথে ফ্রিলান্সিং করে আসছেন, ও ৩০০+ প্রজেক্ট সম্পন্ন করিয়েছেন
                          </p>
                          <p>
      ...
      <div class="container">
          <div class="hire_details">
              <div class="hire_title">
                ...
                <p>
                  আপনার কোন প্রজেক্ট থাকলে আমাদেরকে হারার করতে পারেন, আমাদের রয়েছে কমপ্লিট ফ্রন্টএন্ড ও ব্যাকএন্ড টিম ও এসইও স্পেসালিস্ট
                </p>
              </div>
