                ...
                <div class="course_card_area">
                    ...
                    <div class="c_card card_1">
                        <div class="card_img_area">
                            <div class="card_img">
                                <img src="{{ asset('frontend') }}/assets/images/home_page_image/our_course_specialty/support.png"
                    ...
                    <div class="c_card card_2">
                        <div class="card_img_area">
                            <div class="card_img">
                                <img src="{{ asset('frontend') }}/assets/images/home_page_image/our_course_specialty/live.png"
                                    alt="card tech park it
                                ">
                            </div>
                        </div>
                    ...
                    <div class="c_card card_3">
                        <div class="card_img_area">
                            <div class="card_img">
                                <img src="{{ asset('frontend') }}/assets/images/home_page_image/our_course_specialty/quiz.png"
                                    alt="card tech park it
                                ">
                            </div>
                        </div>
                    ...
                    <div class="c_card card_4">
                        <div class="card_img_area">
                            <div class="card_img">
                                <img src="{{ asset('frontend') }}/assets/images/home_page_image/our_course_specialty/tainer.png"
                                    alt="card tech park it
                                ">
                            </div>
                        </div>
                    ...
                    <div class="c_card card_5">
                        <div class="card_img_area">
                            <div class="card_img">
                                <img src="{{ asset('frontend') }}/assets/images/home_page_image/our_course_specialty/certificate.png"
                                    alt="card tech park it
                                ">
                            </div>
                        </div>
